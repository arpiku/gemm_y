...
//
// The CMake-selected arch (sm_90 / sm_100 / sm_120) propagates as a
// CUDA_ARCH_SM_* preprocessor define. This header maps it to a string for use
// in CSV rows, log output, and file paths.
...
#define GEMM_Y_ARCH_NAME "sm_100"
#elif defined(CUDA_ARCH_SM_120)
#define GEMM_Y_ARCH_NAME "sm_120"
#else
#error                                                                         \
    "Neither CUDA_ARCH_SM_90, CUDA_ARCH_SM_100, nor CUDA_ARCH_SM_120 is defined."
#endif
